...
const Navbar: React.FC = () => {
  ...
  const currentColor =
    colorMap[pathname as keyof typeof colorMap]?.color || "zluta";
  const logo =
    colorMap[pathname as keyof typeof colorMap]?.logo || colorMap["/domu"].logo;
  ...
  return (
    <nav className="shadow-md relative">
      <div className="sirka px-4">
        <div className="flex items-center justify-between h-32 gap-0">
          ...
          <div className="hidden lg:flex ml-auto gap-16">
            ...
            <div className="ml-16">
              <Button to="https://www.jalshop.cz/" width="200px">
                E-SHOP
              </Button>
            </div>
          </div>
      ...
      <div
        ...
        } fixed top-0 left-0 right-0 bg-white shadow-lg z-40`}
      >
