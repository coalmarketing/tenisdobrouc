  ...
  return (
    <div id='reservation'>
      <div className='flex -mt-[6.3rem] sirka justify-center'>
        <div className="px-10 mx-0 md:mx-16 w-full py-8 z-20 flex justify-between items-center gap-20 rounded-3xl bg-white shadow-xl
          ...
          <p className='text-[1.7rem] font-bold text-center sm:text-left'>
            Rezervujte si svůj kurt <span className='text-zluta'>ještě dnes:</span>
          </p>
          <div className='flex flex-col xl:flex-row gap-3 sm:gap-4'>
            <div className='relative flex flex-col sm:flex-row gap-3' ref={buttonRef}>
              ...
              {calendarOpen && (
                <div
                  ref={calendarRef}
                  className={`absolute ${openUpwards ? 'bottom-full mb-2' : 'top-full mt-2'} z-50 left-0 custom-datepicker-wrapper`}>
                  <DatePicker 
                    selected={startDate} 
